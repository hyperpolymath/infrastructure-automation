...
// Replace infrastructure-automation, Infrastructure Automation — See README.adoc for details., just run, Infrastructure Automation started successfully. with actuals
= infrastructure-automation — Quick Start for Users
:toc:
:toclevels: 2

== What is infrastructure-automation?

Infrastructure Automation — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./infrastructure-automation-portable
----
...
[source]
----
Infrastructure Automation started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/infrastructure-automation/wiki
