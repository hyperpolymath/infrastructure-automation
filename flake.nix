{
  description = "infrastructure-automation - {project-description}";
    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in
      {
        ...
        packages.default = pkgs.stdenv.mkDerivation {
          pname = "infrastructure-automation";
          version = "0.1.0";
          src = ./.;
          ...
          buildPhase = ''
            ...
            # For Ada: gprbuild -P infrastructure-automation.gpr -XMODE=release
          '';

          installPhase = ''
            mkdir -p $out/bin
            # *REMINDER: Add install commands*
            # cp target/release/infrastructure-automation $out/bin/  # Rust
            # cp bin/infrastructure-automation $out/bin/  # Ada
          '';
        ...
        apps.default = {
          type = "app";
          program = "${self.packages.${system}.default}/bin/infrastructure-automation";
        };
        ...
        checks = {
          ...
          test = pkgs.runCommand "test-infrastructure-automation" {
